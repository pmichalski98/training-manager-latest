  ...
  return (
    <>
      ...
      {data
        .filter(
          (trainingUnit) =>
            trainingUnit.endedAt.getDate() !== trainingUnit.createdAt.getDate()
        )
        .map((trainingUnit) => (
          <div className="mt-32" key={trainingUnit.id}>
            <h2>{trainingUnit.createdAt.getMonth()}</h2>
            <div className="   space-y-2 rounded-lg px-4 py-4 ring-1 ring-primary/30 hover:ring-primary sm:px-6">
              ...
              <div className="flex items-center gap-2 text-sm opacity-75">
                ...
                <p>
                  {trainingUnit.endedAt.getDate() -
                    trainingUnit.createdAt.getDate()}
                </p>
              </div>
